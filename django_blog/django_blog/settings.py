...
SECRET_KEY = 'django-insecure-q8%0n&n8#6(&7&y4#=61p+42eg^fdm^s^_i^g4nf-rg6%%a35g'
...
DATABASES = {
    'default': {
        ...
        'USER': 'blog_user',         # your PostgreSQL user
        'PASSWORD': 'bloguser@1060',  # your PostgreSQL password
